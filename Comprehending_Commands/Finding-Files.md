...
## My solve
**Flag:** `pwn.college{ICL-5iWV6uHdlcbDq1axzeSH3WT.QXyMDO0wSOyMzNzEzW}`
...
/usr/local/lib/python3.8/dist-packages/itsdangerous/flag
...
hacker@commands~finding-files:~$ cat /usr/local/lib/python3.8/dist-packages/itsdangerous/flag
pwn.college{ICL-5iWV6uHdlcbDq1axzeSH3WT.QXyMDO0wSOyMzNzEzW}hacker@commands~finding-files:~$
```
